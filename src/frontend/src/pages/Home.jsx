    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              {!isAuthenticated() && (
                <Link to="/register" className="btn-secondary border-2 border-white text-white hover:bg-white hover:text-primary">
                  Crear Cuenta
                </Link>
              )}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Solo ofrecemos productos de la más alta calidad</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Procesamiento seguro con Stripe</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Genera facturas fiscales fácilmente</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-orange-500 to-orange-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">Explora nuestro catálogo y encuentra lo que necesitas</p>
          <Link to="/products" className="btn-primary bg-white text-primary hover:bg-gray-100">
